...
;smoketest.c:29: set_bkg_data(2, earth_data_size >> 4, earth_data);
	...
	srl	h
	rr	l
;../../../include/msx/msx.h:568: set_native_tile_data(start, ntiles, src);
	push	bc
	push	hl
	ld	hl, #0x0002
	push	hl
...
;smoketest.c:30: set_sprite_data(0, earth_data_size >> 4, earth_data);
	...
	srl	h
	rr	l
;../../../include/msx/msx.h:571: set_sprite_1bpp_data(start, ntiles, src);
	push	bc
	push	hl
	ld	hl, #0x0000
	push	hl
	call	_set_sprite_1bpp_data
;../../../include/msx/msx.h:734: shadow_OAM[nb].tile=tile;
	ld	hl, #_shadow_OAM+2
	ld	(hl), #0x00
	ld	hl, #_shadow_OAM+6
	ld	(hl), #0x02
...
;smoketest.c:72: move_sprite(0, x >> 4, y >> 4);
	...
	rr	l
	ld	c, l
;../../../include/msx/msx.h:769: OAM_item_t * itm = &shadow_OAM[nb];
;../../../include/msx/msx.h:770: itm->y=y, itm->x=x;
	ld	hl, #_shadow_OAM
	ld	(hl), b
	ld	hl, #(_shadow_OAM + 1)
	ld	(hl), c
